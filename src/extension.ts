...
thead th{position:sticky;top:0;z-index:2;background-color:var(--vscode-panel-background,var(--vscode-editor-background,#1f1f1f));background-clip:padding-box;box-shadow:0 1px 0 var(--vscode-panel-border,rgba(128,128,128,.4));font-weight:600;text-align:left;white-space:nowrap;padding:7px 14px 7px 12px;letter-spacing:.01em}
